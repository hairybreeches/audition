...
namespace Tests
{
    ...
    public class DescriptionTests
    {
        ...
        public void DescriptionCorrectForRoundNumberSearchWindow()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Journals Ending in at least 3 zeroes, in the period 01/01/1999 to 31/12/1999", window.Description);
        }
        ...
        public void DescriptionCorrectForWorkingHoursSearchWindow()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Journals posted outside Monday to Thursday, 9:30 to 18:00, in the period 01/04/2000 to 31/03/2001", window.Description);
        }    
        ...
        public void DescriptionCorrectForUnusualAccountsSearchWindow()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Journals posted to nominal codes with fewer than 4 entries, in the period 01/04/2000 to 31/03/2001", window.Description);
        }
        ...
        public void DescriptionCorrectForUserSearchWindow()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Journals posted by users other than steve, alf or betty, in the period 01/04/2000 to 31/03/2001", window.Description);
        } 
        ...
        public void DescriptionCorrectForYearEndWindow()
        {
            ...
            StringAssert.AreEqualIgnoringCase("Journals posted after the year end or within 5 days before, in the period 01/04/2000 to 31/03/2001", window.Description);
        }
