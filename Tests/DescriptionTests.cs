...
namespace Tests
{
    ...
    public class DescriptionTests
    {
        ...
        {
            var window = new SearchWindow<UnusualNominalCodesParameters>(new UnusualNominalCodesParameters(4), new DateRange(new DateTime(2000,4,1), new DateTime(2001, 3, 31)));
