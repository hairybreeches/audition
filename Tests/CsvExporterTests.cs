...
Created,Date
" + new DateTimeOffset(new DateTime(2012,3,4), TimeSpan.FromHours(0)) + "," + new DateTime(2012, 3, 4).ToShortDateString() + @",Cr,9012,Expenses,23.4,Dr,3001,Cash,23.4
" + new DateTimeOffset(new DateTime(2012,6,5), TimeSpan.FromHours(1)) + "," + new DateTime(2012, 6, 5).ToShortDateString() + @",Cr,8014,Depreciation,12.4,Dr,4001,Fixed assets,12.4
";
