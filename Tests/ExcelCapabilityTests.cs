        ...
        public IEnumerable<TestCaseData> SingleFieldMapped
        {
            get
            {
                ...
                yield return CreateTestCase("Account name mapped", 
                    new FieldLookups(id: -1, accountCode: -1, accountName: 3, amount: -1, created: -1, description: -1, transactionDate: 18, username: -1), 
                    new Dictionary<string, string>().WithAllErrorMessages(), 
                ...
                yield return CreateTestCase("Description mapped", 
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: 4, transactionDate: 18, username: -1), 
                    new Dictionary<string, string>().WithAllErrorMessages(), 
                    DisplayField.TransactionDate, DisplayField.Description);

                yield return CreateTestCase("Username mapped", 
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: -1, transactionDate: 18, username: 319), 
            ...
            get
            {
                yield return CreateTestCase("All fields mapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: 18,
                        transactionDate: 18, username: 18),
        ...
        public IEnumerable<TestCaseData> SingleFieldUnmapped
        {
            get
            {
                ...
                yield return CreateTestCase("Account name unmapped", 
                    new FieldLookups(id: 18, accountCode: 18, accountName: -1, amount: 18, created: 18, description: 18, transactionDate: 18, username: 18), 
                    new Dictionary<string, string>(), 
                ...
                yield return CreateTestCase("Description unmapped", 
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: -1, transactionDate: 18, username: 18), 
                    new Dictionary<string, string>(), 
                    Enums.GetAllValues<DisplayField>().Without(DisplayField.Description));

                yield return CreateTestCase("Username unmapped", 
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: 18, transactionDate: 18, username: -1), 
