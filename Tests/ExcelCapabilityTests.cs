        ...
        public IEnumerable<TestCaseData> SingleFieldMapped
        {
            get
            {
                yield return CreateTestCase("ID mapped", 
                    new FieldLookups(id: 1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: -1, transactionDate: 18, username: -1, type: -1), 
                ...
                yield return CreateTestCase("Account Code mapped",
                    new FieldLookups(id: -1, accountCode: 12, accountName: -1, amount: -1, created: -1, description: -1, transactionDate: 18, username: -1, type: -1), 
                ...
                yield return CreateTestCase("Account name mapped",
                    new FieldLookups(id: -1, accountCode: -1, accountName: 3, amount: -1, created: -1, description: -1, transactionDate: 18, username: -1, type: -1), 
                    new Dictionary<string, string>().WithAllErrorMessages(), 
                    DisplayField.TransactionDate, DisplayField.AccountName);

                yield return CreateTestCase("Amount mapped",
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: 5, created: -1, description: -1, transactionDate: 18, username: -1, type: -1), 
                ...
                yield return CreateTestCase("Description mapped",
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: 4, transactionDate: 18, username: -1, type: -1), 
                    new Dictionary<string, string>().WithAllErrorMessages(), 
                    DisplayField.TransactionDate, DisplayField.Description);

                yield return CreateTestCase("Username mapped",
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: -1, transactionDate: 18, username: 319, type: -1), 
                ...
                yield return CreateTestCase("Transaction type mapped",
                    new FieldLookups(id: -1, accountCode: -1, accountName: -1, amount: -1, created: -1, description: -1, transactionDate: 18, username: -1, type: 23), 
                    new Dictionary<string, string>().WithAllErrorMessages(), 
        ...
        public IEnumerable<TestCaseData> SingleFieldUnmapped
        {
            get
            {
                yield return CreateTestCase("ID unmapped", 
                    new FieldLookups(id: -1, accountCode: 18, accountName: 18, amount: 18, created: 18, description: 18, transactionDate: 18, username: 18, type: 18), 
                    new Dictionary<string, string>(), 
                    Enums.GetAllValues<DisplayField>().Without(DisplayField.Id));

                yield return CreateTestCase("Account Code unmapped",
                    new FieldLookups(id: 18, accountCode: -1, accountName: 18, amount: 18, created: 18, description: 18, transactionDate: 18, username: 18, type: 18), 
                ...
                yield return CreateTestCase("Account name unmapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: -1, amount: 18, created: 18, description: 18, transactionDate: 18, username: 18, type: 18), 
                    new Dictionary<string, string>(), 
                    Enums.GetAllValues<DisplayField>().Without(DisplayField.AccountName));

                yield return CreateTestCase("Amount unmapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: -1, created: 18, description: 18, transactionDate: 18, username: 18, type: 18), 
                ...
                yield return CreateTestCase("Description unmapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: -1, transactionDate: 18, username: 18, type: 18), 
                    new Dictionary<string, string>(), 
                    Enums.GetAllValues<DisplayField>().Without(DisplayField.Description));

                yield return CreateTestCase("Username unmapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: 18, transactionDate: 18, username: -1, type: 18), 
                ...
                yield return CreateTestCase("Type unmapped",
                    new FieldLookups(id: 18, accountCode: 18, accountName: 18, amount: 18, created: 18, description: 18, transactionDate: 18, username: 18, type: -1), 
                    new Dictionary<string, string>(), 
