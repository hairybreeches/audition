...
namespace Capabilities
{
    public class DisplayFieldProvider
    {
        ...
        public DisplayField AccountName = new DisplayField(DisplayFieldName.NominalName, MappingFields.NominalName, entry => entry.NominalCodeName);
        public DisplayField Amount = new DisplayField(DisplayFieldName.Amount, MappingFields.Amount, entry => entry.Amount);
        public DisplayField AccountCode = new DisplayField(DisplayFieldName.NominalCode, MappingFields.NominalCode, entry => entry.NominalCode);
